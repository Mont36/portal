...
export const latestNews: NewsItem[] = [
  {
    ...
    excerpt: "Коротко о новом трейлере: ждём больше деталей о героях, мире и тоне игры.",
    category: "Официально",
    href: "/news",
    date: "2 часа назад",
...
export const importantSections: ImportantSectionItem[] = [
  {
    title: "Карта GTA 6",
    description: "Леонида, Vice City и ключевые районы",
    href: "/karta",
    cta: "Смотреть карту",
    accent: "cyan",
  },
  {
    title: "Персонажи",
    description: "Главные герои и сюжетные связи",
    href: "/personazhi",
    cta: "Подробнее",
    accent: "pink",
  },
  {
    title: "GTA 6 Online",
    description: "Онлайн-режим, активности и сезоны",
    href: "/online",
    cta: "Читать",
    accent: "violet",
  },
  {
    title: "RP сервера",
    description: "Будущие проекты и режимы RP",
    href: "/rp",
    cta: "Выбрать сервер",
    accent: "pink",
  },
...
export const servers: ServerItem[] = [
  {
    ...
    online: "320/1000",
    status: "RU",
    description: "Криминальный RP с фракциями и бизнесами.",
    tag: "vice",
    accent: "pink",
  },
  {
    ...
    online: "278/1000",
    status: "RU",
    description: "Полиция, банды и мягкий старт для новичков.",
    tag: "leonida",
    accent: "violet",
  },
  {
    ...
    online: "195/1000",
    status: "EN",
    description: "Открытый мир, гонки и городской RP.",
    tag: "sunshine",
    accent: "cyan",
  },
  {
    ...
    online: "150/1000",
    status: "RU",
    description: "Команды, заявки и первые RP-сценарии.",
    tag: "project",
    accent: "pink",
  },
];
