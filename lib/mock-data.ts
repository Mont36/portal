...
export const latestNews: NewsItem[] = [
  {
    ...
    excerpt: "Rockstar подтвердила, что второй трейлер GTA 6 будет показан в начале 2025 года. Ожидается больше деталей о сюжете, героях и мире игры.",
    category: "Официально",
    href: "/news",
    date: "2 часа назад",
...
export const importantSections: ImportantSectionItem[] = [
  ...
  {
    title: "Персонажи",
    description: "Познакомьтесь с героями GTA 6 и их историями.",
    href: "/personazhi",
    cta: "Подробнее",
    accent: "pink",
  },
...
export const servers: ServerItem[] = [
  ...
  },
  {
    ...
    online: "278/1000",
    status: "RU",
    description: "Medium RP",
    image: "/images/home/hero-secondary.png",
    tag: "leonida",
    accent: "violet",
  },
  {
  ...
  },
  {
    ...
    status: "RU",
    description: "Soft RP",
    image: "/images/home/rp-preview.png",
    tag: "project",
    accent: "pink",
  },
];
